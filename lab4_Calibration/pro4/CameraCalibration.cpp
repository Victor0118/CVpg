...
//    FILE *fptr = fopen(argv[3],"r");
    FILE *fptr = fopen("/Users/Victor/Desktop/CV/opencvCFSS/mychessboards.txt","r");
    ...
    for( int frame=0; frame<n_boards; frame++ ) {
        ...
        char fullnames[2048]= "/Users/Victor/Desktop/CV/opencvCFSS";
        strcat(fullnames, names);
        image = cvLoadImage( fullnames);
    ...
    // Save our work
    cvSave("/Users/Victor/Desktop/CV/opencvCFSS/Intrinsics.xml",intrinsic_matrix);
    cvSave("/Users/Victor/Desktop/CV/opencvCFSS/Distortion.xml",distortion_coeffs);
    // Load test
