...
extern Point2f offset_pct;
extern Point dest_sz;
extern int startnum;
extern eigenFace ef;
extern bool errorflag;
extern string prefix3;
cv::Point leftPupil;
cv::Point rightPupil;
/** Constants **/
...
cv::String face_cascade_name = "/Volumes/mac/Mac Download/eyeLike-master/res/haarcascade_frontalface_alt.xml";
